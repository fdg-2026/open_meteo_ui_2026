            ...
            children: [
              ...
              RadioGroup<String?>(
                groupValue: settingsProvider
                    .settings
                    .localeAsString, // Zentral gesteuert
                ...
                child: Column(
                  children: [
                    ...
                    RadioListTile<String?>(
                      title: Text(l10n.sp_localeFR, style: textStyle),
                      value: "fr",
                    ),
                    RadioListTile<String?>(
                      title: Text(l10n.sp_localeES, style: textStyle),
                      value: "es",
                    ),
                    RadioListTile<String?>(
                      title: Text(l10n.sp_localeZH, style: textStyle),
                      value: "zh",
                    ),
                  ],
                ),
